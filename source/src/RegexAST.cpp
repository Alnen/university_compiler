...
RegexToASTParser::parse_asnswer_t RegexToASTParser::parse_char_sequence_element(const std::string& regex, size_t offset, CharClassCheckNode& node)
{
...
RegexToASTParser::parse_asnswer_t RegexToASTParser::parse_char_sequence(const std::string& regex, size_t offset, CharClassCheckNode& node)
{
...
RegexToASTParser::parse_asnswer_t RegexToASTParser::parse_char_class(const std::string& regex, size_t offset)
{
...
RegexToASTParser::parse_asnswer_t RegexToASTParser::parse_char(const std::string& regex, size_t offset)
{
    ...
    {
        return parse_asnswer_t(true, std::make_unique<CharCheckNode>(++m_idGenerator, regex[offset]), offset+1);
    }
    else
    {
        return parse_asnswer_t(offset);
...
RegexToASTParser::parse_asnswer_t RegexToASTParser::parse_group(const std::string& regex, size_t offset)
{
...
RegexToASTParser::parse_asnswer_t RegexToASTParser::parse_single_element(const std::string& regex, size_t offset)
{
...
RegexToASTParser::parse_asnswer_t RegexToASTParser::parse_zero_or_more(const std::string& regex, size_t offset)
{
...
RegexToASTParser::parse_asnswer_t RegexToASTParser::parse_sequence(const std::string& regex, size_t offset)
{
...
RegexToASTParser::parse_asnswer_t RegexToASTParser::parse_or(const std::string& regex, size_t offset)
{
