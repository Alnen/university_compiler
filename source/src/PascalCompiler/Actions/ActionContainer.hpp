...
auto ActionContainer = boost::hana::make_tuple(
    ...
    boost::hana::make_pair(boost::hana::int_c<IndexListAppendAtStart>,    boost::hana::type_c<PascalCompiler::IndexListAppendAtStart>),
    boost::hana::make_pair(boost::hana::int_c<IndexListInit>,             boost::hana::type_c<PascalCompiler::IndexListInit>),
