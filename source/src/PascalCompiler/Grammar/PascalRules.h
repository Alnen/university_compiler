...
// TYPE SECTION (DONE)
    ...
    {Massive, {RWAR, SRLB, Index, NextIndex, SRRB, RWOF, DefiniteType}, ArrayCreationAction},
    {NextIndex, {EPSILON}, IndexListInit},
    {NextIndex, {SRCA, Index, NextIndex}, IndexListAppendAtStart},
